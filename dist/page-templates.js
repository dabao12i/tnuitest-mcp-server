...
exports.componentRoles = exports.pageTypeKeywords = exports.pageTemplates = void 0;
...
exports.pageTemplates = [
    {
        ...
        name: 'Login Page',
        nameZh: '登录页面',
        description: 'User login page with username/password or phone/verification code',
        category: 'auth',
    ...
    },
    {
        ...
        nameZh: '个人中心',
        description: 'User profile and settings page with avatar, info list, and menu',
        category: 'profile',
...
function detectPageType(description) {
    ...
    for (const [pageType, keywords] of Object.entries(exports.pageTypeKeywords)) {
        let matchCount = 0;
...
function getPageTemplate(pageType) {
    return exports.pageTemplates.find((t) => t.id === pageType);
}
// Generate suggested code for page type
function generatePageCode(template) {
...
function generateComponentAttrs(usage) {
    const attrs = [];
    switch (usage.component) {
        case 'tn-button':
            attrs.push(`type="primary"`);
            if (usage.role.includes('login') ||
